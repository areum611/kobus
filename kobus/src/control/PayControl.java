...
public class PayControl extends HttpServlet {
	...
	private void initCommand() {
		...
		commandMap.put("calcleList-page", new PayCommandCancleList("ReserCancelListView.jsp"));
		commandMap.put("cancelSubmit", new PayCommandCancelSubmit("payCancelSubmit.jsp"));
