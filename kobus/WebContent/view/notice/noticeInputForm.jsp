						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for="name"> 작성자</label> <input type="hidden"
										class="form-control" id="n_writer" name="n_writer"
										placeholder="Enter name" required="required" value="<%=mId%>" />
									&nbsp;&nbsp;&nbsp;<%=mId%>
								</div>
								<div class="form-group">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control" id="n_title"
											name="n_title" placeholder="Enter title" required="required" />
									</div>
								</div>
