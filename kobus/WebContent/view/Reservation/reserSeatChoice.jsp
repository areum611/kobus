...
<form name="satsChcFrm" id="satsChcFrm" method="post"  action="/mrs/satschc.do" >
<!-- 	<input type="hidden" name="deprCd"         id="deprCd"         value="115" />출발지코드 -->
	<input type="hidden" name="deprNm"         id="deprNm"         value="<%=SM.getDepplacenm() %>" /><!-- 출발지명 -->
<!-- 	<input type="hidden" name="arvlCd"         id="arvlCd"         value="602" />도착지코드 -->
	<input type="hidden" name="arvlNm"         id="arvlNm"         value="<%=SM.getArrplacenm() %>" /><!-- 도착지명 -->
...
<!-- 	<input type="hidden" name="deprDt"         id="deprDt"         value="20171020" />출발일 -->
	<input type="hidden" name="deprTime"       id="deprTime"       value="<%=SM.getDepplandtime() %>" /><!-- 출발시각 -->
	
	<input type="hidden" name="alcnDeprTime"   id="alcnDeprTime"   value="<%=SM.getDepplandtime() %>" /><!-- 배차출발시각 -->


	
	<input type="hidden" name="adltFee"        id="adltFee"         value="<%=SM.getCharge() %>" /><!-- 일반금액 -->
				...
				<div class="selectSeat_wrap">
					...
					<div class="compare_wrap">
						...
						<div class="infoBox">
								...
								<p class="date" id="satsDeprDtm"><!-- 출발일 --></p>
								
							
							<div class="route_wrap" id="satsRotInfo">
								<div class="inner">
									<p class="roundBox departure" id="satsDeprTmlNm" >-</p><!-- 출발지 -->
									
									
									<p class="roundBox arrive" id="satsArvlTmlNm">-</p><!-- 도착지 -->
								</div>
								...
								<ul class="sel_list" id="mobileSelCnt">
												...
												<li>
													<div class="countBox">
														<p class="division">
															<em>일반</em>
															<span class="text_num count" id="adltCntMob">0</span>
														</p>
														<div class="btn_wrap">
															<ul>
																<li><button type="button" class="btn btn_minus"><span class="ico_minus">감소</span></button></li>
																<li><button type="button" class="btn btn_add"><span class="ico_plus">증가</span></button></li>
															</ul>
														</div>
													</div>
												</li>
									...
									<ul class="sel_list">
													...
													<li>
														<div class="countBox">
															<p class="division">
																<em>매수</em>
																<span class="text_num count" id="adltCnt">0</span>
															</p>
															<div class="btn_wrap">
																<ul>
																	<li><button type="button" class="btn btn_minus"><span class="ico_minus">감소</span></button></li>
								...
								<div class="selectSeat_box">
									<div class="bg_seatBox seat28" style="display:block;">
										<div class="seatList">
													...
													<span class="seatBox">
														<input type="checkbox" name="seatBoxDtl" id="seatNum_28_01" value="1" onclick="fnSeatChc(this);" >
													...
													<span class="seatBox">
														<input type="checkbox" name="seatBoxDtl" id="seatNum_28_03" value="3" onclick="fnSeatChc(this);" >
									...
									<table class="taR">
										...
										<caption>
											...
											<p>결제금액, 취소 수수료(예상), 반환금액</p>
												...
												<tr>
													<th scope="row" class="txt_black"><strong>총결제 금액(<span id="adltSeatCnt">0</span>)</strong></th>
