        	...
        	if(alcnListMap.rotVldChc == "N"){
        		...
        		if(alcnListMap.alcnAllList != null){
        			...
        			for(var inx  = 0 ; inx < alcnListMap.alcnAllList.length ; inx++){
        				alcnList +="<p class='"+alcnListMap.alcnAllList[inx].BUS_CLS_CD_CSS+"' data-time='"+alcnListMap.alcnAllList[inx].TIME_CHC+"'>";
        				alcnList +="<span class='start_time'>"+alcnListMap.alcnAllList[inx].DEPR_TIME_DVS+"</span>";
        				alcnList +="<span class='bus_info'><span class='"+alcnListMap.alcnAllList[inx].CACM_CSS+"'>"+alcnListMap.alcnAllList[inx].CACM_MN+"</span><span class='grade_mo'>"+alcnListMap.alcnAllList[inx].BUS_CLS_NM+"</span></span>";
        				alcnList +="<span class='bus_com'><span class='"+alcnListMap.alcnAllList[inx].CACM_CSS+"'>"+alcnListMap.alcnAllList[inx].CACM_MN+"</span></span>";
        				alcnList +="<span class='grade'>"+alcnListMap.alcnAllList[inx].BUS_CLS_NM+"</span>";
        				alcnList +="<span class='adult'>"+comma(alcnListMap.alcnAllList[inx].ADLT_FEE)+"원</span>";
        				alcnList +="<span class='child'>"+comma(alcnListMap.alcnAllList[inx].CHLD_FEE)+"원</span>";
        				if(alcnListMap.alcnAllList[inx].TEEN_FEE!=0){
        					alcnList +="<span class='youth'>"+comma(alcnListMap.alcnAllList[inx].TEEN_FEE)+"원</span>";
        				}else{
        					alcnList +="<span class='youth'></span>";
        				}
        				alcnList +="<span class='remain'>"+alcnListMap.alcnAllList[inx].RMN_SATS_NUM+" <span class='total_seat'>/ "+alcnListMap.alcnAllList[inx].TOT_SATS_NUM+"</span></span></p>";
        			}
